...
import type { ConvertBlendToGlbPayload, PreviewStudioBridge, SaveBinaryPayload, SaveDataUrlPayload, SaveMp4FromWebmPayload } from "../shared/ipcTypes.js"

const bridge: PreviewStudioBridge = {
  openFiles: () => ipcRenderer.invoke("dialog:openFiles"),
  openFolder: () => ipcRenderer.invoke("dialog:openFolder"),
  convertBlendToGlb: (payload: ConvertBlendToGlbPayload) => ipcRenderer.invoke("blend:convertToGlb", payload),
